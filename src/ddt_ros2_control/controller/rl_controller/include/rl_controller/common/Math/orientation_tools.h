...
#ifndef RL_CONTROLLER__COMMON__MATH__ORIENTATION_TOOLS_H_
#define RL_CONTROLLER__COMMON__MATH__ORIENTATION_TOOLS_H_
...
#endif  // RL_CONTROLLER__COMMON__MATH__ORIENTATION_TOOLS_H_
